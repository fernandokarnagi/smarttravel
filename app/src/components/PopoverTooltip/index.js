...
export class PopoverItem extends React.Component {
    ...
    render() {
        return (
            <span>
                <Button className="mr-1 mb-2" color="secondary" id={'Popover-' + this.props.id} onClick={this.toggle}>
...
export class TooltipItem extends React.Component {
    ...
    render() {
        return (
            <span>
                <Button className="mr-1 mb-2" color="secondary" id={'Tooltip-' + this.props.id}>
                    {this.props.item.text}
                </Button>
                <Tooltip
                    placement={this.props.item.placement}
