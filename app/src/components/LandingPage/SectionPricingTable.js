            ...
            <Fragment>
                <Row>
                    <Colxx xxs={{ size: '12', offset: 0 }} lg={{ size: 8, offset: 2 }} className="text-center">
                        <h1>
                            <IntlMessages id="lp.pricetable.title" />
                        </h1>
                        <p>
                        ...
                        <Card>
                            <CardBody className="pt-5 pb-5 d-flex flex-lg-column flex-md-row flex-sm-row flex-column">
                                <div className="price-top-part">
                                    <i className="iconsmind-Male large-icon" />
                                    ...
                                    <p className="text-muted text-small">
                                        {' '}
                                        <IntlMessages id="lp.pricetable.detail-1" />
                                    </p>
                                </div>
                                <div className="pl-3 pr-3 pt-3 pb-0 d-flex price-feature-list flex-column flex-grow-1">
                                    <ul className="list-unstyled">
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-1-1" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-1-2" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-1-3" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-1-4" />
                                            </p>
                                        </li>
                                    </ul>
                                    <div>
                                        <NavLink to="/auth-login" className="btn btn-link btn-empty btn-lg">
                                            <IntlMessages id="lp.pricetable.purchase" />{' '}
                            ...
                            <CardBody className="pt-5 pb-5 d-flex flex-lg-column flex-md-row flex-sm-row flex-column">
                                ...
                                <div className="pl-3 pr-3 pt-3 pb-0 d-flex price-feature-list flex-column flex-grow-1">
                                    <ul className="list-unstyled">
                                        ...
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-2-2" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-2-3" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-2-4" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-2-5" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-2-6" />
                                            </p>
                                        </li>
                                    </ul>
                                    <div>
                        ...
                        <Card>
                            <CardBody className="pt-5 pb-5 d-flex flex-lg-column flex-md-row flex-sm-row flex-column">
                                <div className="price-top-part">
                                    ...
                                    <p className="text-muted text-small">
                                        <IntlMessages id="lp.pricetable.detail-3" />
                                    </p>
                                </div>
                                <div className="pl-3 pr-3 pt-3 pb-0 d-flex price-feature-list flex-column flex-grow-1">
                                    <ul className="list-unstyled">
                                        ...
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-3-2" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                        ...
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-3-4" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
                                                <IntlMessages id="lp.pricetable.feature-3-5" />
                                            </p>
                                        </li>
                                        <li>
                                            <p className="mb-0 ">
