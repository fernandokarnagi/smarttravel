        ...
        return (
            <Row>
                <Colxx xxs={{ size: '12' }} lg={{ size: 4 }} className="mb-4">
                    <h1>
                        <IntlMessages id="lp.team.title" />
                    </h1>
                    <p>
                        <IntlMessages id="lp.team.detail-1" />
                        <br />
                        <br />
                        ...
                        <div className="pr-3 pl-3 d-flex">
                            <Card>
                                <div className="position-relative">
                                    <img
                                        className="card-img-top"
                                        src="/assets/img/landing-page/team-5.jpg"
                                        alt="Card cap"
                                    />
                                    <Badge color="theme-3" pill className="position-absolute badge-top-left">
                                        DESIGN
                                    </Badge>
                                </div>
                                <CardBody>
                                    ...
                                    <footer>
                                        <p className="text-muted text-small mb-0 font-weight-light">Artdirector</p>
                                    </footer>
                                </CardBody>
                            </Card>
                        </div>
