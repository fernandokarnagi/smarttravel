...
export default class SectionHero extends React.Component {
    ...
    onResizeLandingPage() {
        ...
        document.querySelector('.landing-page .section.footer').style.backgroundPositionX =
            window.outerWidth - rowOffestFooter - 1668 + 'px';
    }
            ...
            <Fragment>
                        ...
                        <Colxx
                            ...
                            <div className="d-flex flex-column align-items-center">
                                <a
                                    ...
                                    <IntlMessages id="lp.footer.menu-1" /> <i className="simple-icon-arrow-down" />
                                </a>
                                ...
                                <Collapse
                                    ...
                                    <li className="d-none d-xs-inline-block">
                                        <p>
                                            <IntlMessages id="lp.footer.menu-1" />
                                        </p>
                                    </li>
                                    <li>
                                        <NavLink to="/about">
                        ...
                        <Colxx
                            ...
                            <div className="d-flex flex-column align-items-center">
                                <a
                                    ...
                                    <IntlMessages id="lp.footer.menu-2" /> <i className="simple-icon-arrow-down" />
                                </a>
                                ...
                                <Collapse
                                    ...
                                    <li className="d-none d-xs-inline-block">
                                        <p>
                                            <IntlMessages id="lp.footer.menu-2" />
                                        </p>
                                    </li>
                                    <li>
                                        <NavLink to="/features">
                        ...
                        <Colxx
                            ...
                            <div className="d-flex flex-column align-items-center">
                                <a
                                    ...
                                    <IntlMessages id="lp.footer.menu-3" /> <i className="simple-icon-arrow-down" />
                                </a>
                                ...
                                <Collapse
                                    ...
                                    <li className="d-none d-xs-inline-block">
                                        <p>
                                            <IntlMessages id="lp.footer.menu-3" />
                                        </p>
                                    </li>
                                    <li>
                                        <NavLink to="/contact">
                        ...
                        <Colxx
                            ...
                            <div className="d-flex flex-column align-items-center">
                                <a
                                    ...
                                    <IntlMessages id="lp.footer.menu-4" /> <i className="simple-icon-arrow-down" />
                                </a>
                                ...
                                <Collapse
                                    ...
                                    <li className="d-none d-xs-inline-block">
                                        <p>
                                            <IntlMessages id="lp.footer.menu-4" />
                                        </p>
                                    </li>
                                    <li>
                                        <NavLink to="/content">
                ...
                <Container className="copyright pt-5 pb-5">
                    <Row>
                        <div className="col-6">
                            <p className="mb-0">
                                <IntlMessages id="lp.footer.copyright" />
                            </p>
                        </div>
