            ...
            <Fragment>
                <Row>
                    <Colxx xxs={{ size: '12', offset: 0 }} lg={{ size: 8, offset: 2 }} className="text-center">
                        <h1>
                            <IntlMessages id="lp.connect.title" />
                        </h1>
                        <p>
                        ...
                        <ReactSiemaCarousel
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsmind-Speach-Bubble large-icon" />
                                            <h5 className="mb-0 font-weight-semibold">
                                                <IntlMessages id="lp.connect.title-1" />
                                            </h5>
                                        </div>
                                        <NavLink className="btn btn-link font-weight-semibold" to="/features">
                                            <IntlMessages id="lp.connect.button-1" />
                                        </NavLink>
                                    </CardBody>
                                </Card>
                            </div>
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsmind-Conference large-icon" />
                                            <h5 className="mb-0 font-weight-semibold">
                                                <IntlMessages id="lp.connect.title-2" />
                                            </h5>
                                        </div>
                                        <NavLink className="btn btn-link font-weight-semibold" to="/features">
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsmind-Play-Music large-icon" />
                                            <h5 className="mb-0 font-weight-semibold">
                                                <IntlMessages id="lp.connect.title-3" />
                                            </h5>
                                        </div>
                                        <NavLink className="btn btn-link font-weight-semibold" to="/features">
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsmind-Folder-WithDocument large-icon" />
                                            <h5 className="mb-0 font-weight-semibold">
                                                <IntlMessages id="lp.connect.title-4" />
                                            </h5>
                                        </div>
                                        <NavLink className="btn btn-link font-weight-semibold" to="/features">
