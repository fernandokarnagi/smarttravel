            ...
            <Fragment>
                <Row>
                    <Colxx xxs={{ size: '12', offset: 0 }} lg={{ size: 8, offset: 2 }} className="text-center">
                        <h1>
                            <IntlMessages id="lp.featuressection.title" />
                        </h1>
                        <p>
                    ...
                    <Colxx xxs="12" md="6" lg="5" className="d-flex align-items-center">
                        <div className="d-flex">
                            <div className="feature-text-container">
                                <h2>
                                    <IntlMessages id="lp.featuressection.title-1" />
                                </h2>
                                <p>
                                    <IntlMessages id="lp.featuressection.detail-1-1" />
                                    <br />
                                    <br />
                ...
                <Row className="featur1e-row">
                    ...
                    <Colxx
                        ...
                        <div className="d-flex">
                            <div className="feature-text-container">
                                <h2>
                                    <IntlMessages id="lp.featuressection.title-2" />
                                </h2>
                                <p>
                                    <IntlMessages id="lp.featuressection.detail-2-1" />
                                    <br />
                                    <br />
                ...
                <Row className="feature-row">
                    <Colxx xxs="12" md="6" lg="5" className="d-flex align-items-center">
                        <div className="d-flex">
                            <div className="feature-text-container">
                                <h2>
                                    <IntlMessages id="lp.featuressection.title-3" />
                                </h2>
                                <p>
                                    <IntlMessages id="lp.featuressection.detail-3-1" />
                                    <br />
                                    <br />
