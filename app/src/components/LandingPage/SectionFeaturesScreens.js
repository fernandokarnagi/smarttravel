            ...
            <Fragment>
                <Row>
                    <Colxx xxs={{ size: '12', offset: 0 }} lg={{ size: 8, offset: 2 }} className="text-center">
                        <h1>
                            <IntlMessages id="lp.screens.title" />
                        </h1>
                        <p>
                        ...
                        <Nav tabs className="justify-content-center mb-4">
                            <NavItem>
                                <NavLink
                                    ...
                                    <p>
                                        <IntlMessages id="lp.screens.survey" />
                                    </p>
                                </NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink
                                    ...
                                    <p>
                                        <IntlMessages id="lp.screens.chat" />
                                    </p>
                                </NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink
                                    ...
                                    <p>
                                        <IntlMessages id="lp.screens.todo" />
                                    </p>
                                </NavLink>
                            </NavItem>
                        </Nav>
                        <TabContent activeTab={this.state.activeTab}>
                            ...
                            <TabPane className="justify-content-center" tabId="chat">
                                <img
                                    alt="app "
                                    className="app-image"
                                    src="/assets/img/landing-page/application-chat.jpg"
                                />
                            </TabPane>
                            ...
                            <TabPane className="justify-content-center" tabId="todo">
                                <img
                                    alt="app "
                                    className="app-image"
                                    src="/assets/img/landing-page/application-todo.jpg"
                                />
                            </TabPane>
                        </TabContent>
                    </Colxx>
