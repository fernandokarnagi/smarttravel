...
import { Container, UncontrolledDropdown, DropdownToggle, DropdownItem, DropdownMenu } from 'reactstrap';
        ...
        return (
            <Container className="d-flex align-items-center justify-content-between">
                ...
                <Nav className="navbar-nav d-none d-lg-flex flex-row">
                    ...
                    <NavItem>
                        <NavLink className="btn btn-outline-semi-light btn-sm pr-4 pl-4" to="/auth-register">
                            <IntlMessages id="lp.menu.signup" />
                        </NavLink>
                    </NavItem>
                </Nav>
                <NavLink className="mobile-menu-button" to="#" onClick={event => this.openMobileMenu(event)}>
        ...
        return (
            <Container className="d-flex align-items-center justify-content-between">
                ...
                <Nav className="navbar-nav d-none d-lg-flex flex-row">
                    ...
                    <NavItem>
                        <NavLink className="btn btn-outline-semi-light btn-sm pr-4 pl-4" to="auth-login">
                            <IntlMessages id="lp.menu.signup" />
                        </NavLink>
                    </NavItem>
                </Nav>
