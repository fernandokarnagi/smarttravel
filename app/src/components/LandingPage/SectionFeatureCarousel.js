                                ...
                                <CardBody className="text-center">
                                    <div>
                                        ...
                                        <h5 className="mb-0 font-weight-semibold">
                                            <IntlMessages id="lp.featurecarousel.title-1" />
                                        </h5>
                                    </div>
                                    <div>
                            ...
                            <Card>
                                <CardBody className="text-center">
                                    <div>
                                        ...
                                        <h5 className="mb-0 font-weight-semibold">
                                            <IntlMessages id="lp.featurecarousel.title-2" />
                                        </h5>
                                    </div>
                                    <div>
                                        <p className="detail-text">
                            ...
                            <Card>
                                <CardBody className="text-center">
                                    <div>
                                        ...
                                        <h5 className="mb-0 font-weight-semibold">
                                            <IntlMessages id="lp.featurecarousel.title-3" />
                                        </h5>
                                    </div>
                                    <div>
                                        <p className="detail-text">
                            ...
                            <Card>
                                <CardBody className="text-center">
                                    <div>
                                        ...
                                        <h5 className="mb-0 font-weight-semibold">
                                            <IntlMessages id="lp.featurecarousel.title-4" />
                                        </h5>
                                    </div>
                                    <div>
                                        <p className="detail-text">
                            ...
                            <Card>
                                <CardBody className="text-center">
                                    <div>
                                        ...
                                        <h5 className="mb-0 font-weight-semibold">
                                            <IntlMessages id="lp.featurecarousel.title-5" />
                                        </h5>
                                    </div>
                                    <div>
                                        <p className="detail-text">
                                            <IntlMessages id="lp.featurecarousel.detail-5" />
                                        </p>
                                    </div>
                                    <NavLink className="btn btn-link font-weight-semibold" to="/features">
                                        <IntlMessages id="lp.featurecarousel.view" />
