            ...
            <div className={`theme-colors ${this.state.isOpen ? 'shown' : ''}`}>
                <div className="p-4">
                    ...
                    <div className="d-flex flex-row justify-content-between mb-4">
                        ...
                        <a
                            href="#"
                            className={`theme-color theme-color-blue ${selectedColor === 'light.blue' ? 'active' : ''}`}
                        ...
                        <a
                            href="#"
                            className={`theme-color theme-color-red ${selectedColor === 'light.red' ? 'active' : ''}`}
                    ...
                    <div className="d-flex flex-row justify-content-between">
                        ...
                        <a
                            href="#"
                            className={`theme-color theme-color-blue ${selectedColor === 'dark.blue' ? 'active' : ''}`}
                        ...
                        <a
                            href="#"
                            className={`theme-color theme-color-red ${selectedColor === 'dark.red' ? 'active' : ''}`}
                            onClick={e => this.changeThemeColor(e, 'dark.red')}
                        />
                    </div>
                </div>
                <a href="#" className="theme-button" onClick={this.toggle}>
                    {' '}
