                            ...
                            <UncontrolledDropdown className="dropdown-menu-right">
                                ...
                                <DropdownMenu className="position-absolute mt-3" right id="iconMenuDropdown">
                                    <NavLink to="/app/dashboards/default" className="icon-menu-item">
                                        <i className="iconsmind-Shop-4 d-block" /> <IntlMessages id="menu.dashboards" />
                                    </NavLink>

                                    <NavLink to="/app/ui" className="icon-menu-item">
                                        <i className="iconsmind-Pantone d-block" /> <IntlMessages id="menu.ui" />
                                    </NavLink>
                                    <NavLink to="/app/ui/charts" className="icon-menu-item">
                                        <i className="iconsmind-Bar-Chart d-block" /> <IntlMessages id="menu.charts" />
                                    </NavLink>
                                    ...
                                    <NavLink to="/app/applications/survey" className="icon-menu-item">
                                        <i className="iconsmind-Formula d-block" /> <IntlMessages id="menu.survey" />
                                    </NavLink>
                                    <NavLink to="/app/applications/todo" className="icon-menu-item">
                                        <i className="iconsmind-Check d-block" /> <IntlMessages id="menu.todo" />
                                    </NavLink>
                                </DropdownMenu>
                            </UncontrolledDropdown>
                        </div>
