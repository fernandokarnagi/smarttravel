                        ...
                        <PerfectScrollbar option={{ suppressScrollX: true, wheelPropagation: false }}>
                            <Nav vertical className="list-unstyled">
                                ...
                                {/* <NavItem
                                    ...
                                    <NavLink to="/app/layouts" onClick={e => this.openSubMenu(e, 'layouts')}>
                                        <i className="iconsmind-Digital-Drawing" /> <IntlMessages id="menu.layouts" />
                                    </NavLink>
                                </NavItem>
                                <NavItem
                                    className={classnames({
                                    ...
                                    <NavLink to="/app/applications" onClick={e => this.openSubMenu(e, 'applications')}>
                                        <i className="iconsmind-Air-Balloon" /> <IntlMessages id="menu.applications" />
                                    </NavLink>
                                </NavItem>
                                <NavItem
                                    className={classnames({
                                    ...
                                    <NavLink to="/app/ui" onClick={e => this.openSubMenu(e, 'ui')}>
                                        <i className="iconsmind-Pantone" /> <IntlMessages id="menu.ui" />
                                    </NavLink>
                                </NavItem>
                                <NavItem
                                    className={classnames({
                                    ...
                                    <NavLink to="/landingpage" onClick={e => this.openSubMenu(e, 'landingpage')}>
                                        <i className="iconsmind-Space-Needle" /> <IntlMessages id="menu.landingpage" />
                                    </NavLink>
                                </NavItem>
                    ...
                    <div className="scroll">
                        <PerfectScrollbar option={{ suppressScrollX: true, wheelPropagation: false }}>
                            <Nav
                                ...
                                <NavItem>
                                    <NavLink to="/app/dashboards/default">
                                        <i className="simple-icon-briefcase" /> <IntlMessages id="menu.default" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/dashboards/analytics">
                                        <i className="simple-icon-pie-chart" /> <IntlMessages id="menu.analytics" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/dashboards/ecommerce">
                                        <i className="simple-icon-basket-loaded" /> <IntlMessages id="menu.ecommerce" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/dashboards/content">
                                        <i className="simple-icon-doc" /> <IntlMessages id="menu.content" />
                                    </NavLink>
                                </NavItem>
                            </Nav>
                            <Nav
                                ...
                                <NavItem>
                                    <NavLink to="/app/layouts/data-list">
                                        <i className="simple-icon-credit-card" /> <IntlMessages id="menu.data-list" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/layouts/thumb-list">
                                        <i className="simple-icon-list" /> <IntlMessages id="menu.thumb-list" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/layouts/image-list">
                                        <i className="simple-icon-grid" /> <IntlMessages id="menu.image-list" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/layouts/details">
                                        <i className="simple-icon-book-open" /> <IntlMessages id="menu.details" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/layouts/search">
                                        <i className="simple-icon-magnifier" /> <IntlMessages id="menu.search" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <a href="/login" target="_blank">
                                        <i className="simple-icon-user-following" /> <IntlMessages id="menu.login" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/register" target="_blank">
                                        <i className="simple-icon-user-follow" /> <IntlMessages id="menu.register" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                ...
                                <NavItem>
                                    <a href="/error" target="_blank">
                                        <i className="simple-icon-exclamation" /> <IntlMessages id="menu.error" />
                                    </a>
                                </NavItem>
                            </Nav>
                            <Nav
                                ...
                                <NavItem>
                                    <NavLink to="/app/applications/todo">
                                        <i className="simple-icon-check" /> <IntlMessages id="menu.todo" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/applications/survey">
                                        <i className="simple-icon-calculator" /> <IntlMessages id="menu.survey" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/applications/chat">
                                        <i className="simple-icon-bubbles" /> <IntlMessages id="menu.chat" />
                                    </NavLink>
                                </NavItem>
                            </Nav>
                            <Nav
                                className={classnames({
                                    'd-block':
                                        (this.state.selectedParentMenu == 'ui' && this.state.viewingParentMenu == '') ||
                                        this.state.viewingParentMenu == 'ui',
                                })}
                                data-parent="ui">
                                <NavItem>
                                    <NavLink to="/app/ui/alerts">
                                        <i className="simple-icon-bell" /> <IntlMessages id="menu.alerts" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/badges">
                                        <i className="simple-icon-badge" /> <IntlMessages id="menu.badges" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/buttons">
                                        <i className="simple-icon-control-play" /> <IntlMessages id="menu.buttons" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/cards">
                                        <i className="simple-icon-layers" /> <IntlMessages id="menu.cards" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/carousel">
                                        <i className="simple-icon-picture" /> <IntlMessages id="menu.carousel" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/charts">
                                        <i className="simple-icon-chart" /> <IntlMessages id="menu.charts" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/collapse">
                                        <i className="simple-icon-arrow-up" /> <IntlMessages id="menu.collapse" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/dropdowns">
                                        <i className="simple-icon-arrow-down" /> <IntlMessages id="menu.dropdowns" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/editors">
                                        <i className="simple-icon-book-open" /> <IntlMessages id="menu.editors" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/forms">
                                        <i className="simple-icon-check" /> <IntlMessages id="menu.forms" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/form-components">
                                        <i className="simple-icon-puzzle" /> <IntlMessages id="menu.form-components" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/icons">
                                        <i className="simple-icon-star" /> <IntlMessages id="menu.icons" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/input-groups">
                                        <i className="simple-icon-note" /> <IntlMessages id="menu.input-groups" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                ...
                                <NavItem>
                                    <NavLink to="/app/ui/modal">
                                        <i className="simple-icon-docs" /> <IntlMessages id="menu.modal" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/navigation">
                                        <i className="simple-icon-cursor" /> <IntlMessages id="menu.navigation" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/popover-tooltip">
                                        <i className="simple-icon-pin" /> <IntlMessages id="menu.popover-tooltip" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="/app/ui/sortable">
                                        <i className="simple-icon-shuffle" /> <IntlMessages id="menu.sortable" />
                                    </NavLink>
                                </NavItem>
                            </Nav>
                            <Nav
                                ...
                                <NavItem>
                                    <a href="/multipage-home" target="_blank">
                                        <i className="simple-icon-docs" /> <IntlMessages id="menu.multipage-home" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/singlepage-home" target="_blank">
                                        <i className="simple-icon-doc" /> <IntlMessages id="menu.singlepage-home" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/about" target="_blank">
                                        <i className="simple-icon-info" /> <IntlMessages id="menu.about" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                ...
                                <NavItem>
                                    <a href="/blog" target="_blank">
                                        <i className="simple-icon-bubbles" /> <IntlMessages id="menu.blog" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/blog-detail" target="_blank">
                                        <i className="simple-icon-bubble" /> <IntlMessages id="menu.blog-detail" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/careers" target="_blank">
                                        <i className="simple-icon-people" /> <IntlMessages id="menu.careers" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/confirmation" target="_blank">
                                        <i className="simple-icon-check" /> <IntlMessages id="menu.confirmation" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/contact" target="_blank">
                                        <i className="simple-icon-phone" /> <IntlMessages id="menu.contact" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/content" target="_blank">
                                        <i className="simple-icon-book-open" /> <IntlMessages id="menu.content" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/docs" target="_blank">
                                        <i className="simple-icon-notebook" /> <IntlMessages id="menu.docs" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/features" target="_blank">
                                        <i className="simple-icon-chemistry" /> <IntlMessages id="menu.features" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/prices" target="_blank">
                                        <i className="simple-icon-wallet" /> <IntlMessages id="menu.prices" />
                                    </a>
                                </NavItem>
                                <NavItem>
                                    <a href="/videos" target="_blank">
                                        <i className="simple-icon-film" /> <IntlMessages id="menu.videos" />
                                    </a>
                                </NavItem>
                            </Nav>
                            ...
                            <Nav
                                ...
                                data-parent="menu">
                                <NavItem>
                                    <NavLink to="#" onClick={e => this.changeDefaultMenuType(e, 'menu-default')}>
                                        <i className="simple-icon-control-pause" /> <IntlMessages id="menu.default" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="#" onClick={e => this.changeDefaultMenuType(e, 'menu-sub-hidden')}>
                                        <i className="simple-icon-arrow-left" /> <IntlMessages id="menu.subhidden" />
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink to="#" onClick={e => this.changeDefaultMenuType(e, 'menu-hidden')}>
                                        <i className="simple-icon-control-start" /> <IntlMessages id="menu.hidden" />
                                    </NavLink>
                                </NavItem>
                            </Nav>
                        </PerfectScrollbar>
...
const mapStateToProps = ({ menu }) => {
    const { containerClassnames, subHiddenBreakpoint, menuHiddenBreakpoint, menuClickCount } = menu;
    return {
        containerClassnames,
        subHiddenBreakpoint,
