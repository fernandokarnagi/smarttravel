                                                ...
                                                <div className="d-flex flex-grow-1 min-width-zero">
                                                    ...
                                                    <div className="custom-control custom-checkbox pl-1 align-self-center pr-4">
                                                        <CustomInput
                                                            ...
                                                            type="checkbox"
                                                            id={`check_${item.id}`}
                                                            checked={loading ? selectedItems.includes(item.id) : false}
                            ...
                            <ul className="list-unstyled mb-5">
                                <NavItem className={classnames({ active: !filter })}>
                                    <NavLink to="#" onClick={e => this.addFilter('', '')}>
                                        ...
                                        <span className="float-right">{loading && allTodoItems.length}</span>
                                    </NavLink>
                                </NavItem>
                                <NavItem
                                    className={classnames({
                                        active: filter && filter.column === 'status' && filter.value === 'PENDING',
                                    })}>
                                    <NavLink to="#" onClick={e => this.addFilter('status', 'PENDING')}>
                                        <i className="simple-icon-refresh" />
                                        <IntlMessages id="todo.pending-tasks" />
                                        <span className="float-right">
                                            {loading && todoItems.filter(x => x.status === 'PENDING').length}
                                        </span>
                                    </NavLink>
                                </NavItem>
                                <NavItem
                                    ...
                                    <NavLink to="#" onClick={e => this.addFilter('status', 'COMPLETED')}>
                                        ...
                                        <span className="float-right">
                                            {loading && todoItems.filter(x => x.status === 'COMPLETED').length}
                                        </span>
                                    </NavLink>
                                </NavItem>
                            </ul>
