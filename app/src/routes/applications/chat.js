...
import { Row, Card, CardBody, Nav, Input, Button, TabContent, TabPane, CardHeader, NavItem } from 'reactstrap';
        ...
        return loadingConversations && loadingContacts ? (
            <Fragment>
                                        ...
                                        <Fragment key={index}>
                                            <Card
                                                className={`d-inline-block mb-3 float-${
                                                    item.sender != currentUser.id ? 'left' : 'right'
                                                }`}>
                ...
                <ApplicationMenu>
                    ...
                    <TabContent activeTab={this.state.menuActiveTab} className="chat-app-tab-content">
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    <NavLink
                                                        className="d-flex"
                                                        to="#"
                                                        onClick={e => this.handleConversationClick(e, otherUser.id)}>
                                                        <img
                                                            alt={otherUser.name}
                                                            src={otherUser.thumb}
                                                            className="img-thumbnail border-0 rounded-circle mr-3 list-thumbnail align-self-center xsmall"
