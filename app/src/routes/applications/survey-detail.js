...
import { DoughnutShadow } from 'Components/Charts';
                    ...
                    <Colxx xxs="12">
                        ...
                        <div className="float-sm-right mb-2">
                            <ButtonDropdown
                                ...
                                <DropdownToggle size="lg" className="pr-4 pl-4" caret outline color="primary" />
                                <DropdownMenu right>
                                    <DropdownItem header>
                                            ...
                                            <Colxx xxs="12" lg="4" className="mb-4">
                                                <Card className="mb-4">
                                                    <CardBody>
                                                        ...
                                                        <p
                                                            className="mb-3"
                                                            dangerouslySetInnerHTML={{ __html: survey.detail }}
                                                        />
                        ...
                        <div className="p-4">
                            ...
                            <FormGroup className="mb-5">
                                <CustomInput
                                    ...
                                    className="mb-2"
                                />
                                <CustomInput type="checkbox" id="workplaceCheck" className="mb-2" label="Workplace" />
                                <CustomInput type="checkbox" id="hardwareCheck" className="mb-2" label="Hardware" />
                            </FormGroup>
