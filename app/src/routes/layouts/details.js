                                ...
                                <Row>
                                    <Colxx xxs="12" lg="4" className="mb-4">
                                        <Card className="mb-4">
                                            ...
                                            <img src="/assets/img/detail.jpg" alt="Detail" className="card-img-top" />
                                            ...
                                            <CardBody>
                                                ...
                                                <p className="mb-3">
                                                    It’s all about simplicity…Less is more. Chocolate Cake exclusively
                                                    brings you the classic chocolate cake. This cake is the one you
                                                    always dream of-moist cake and creamy chocolate frosting.
                                                    <br />
                                                    <br /> This cake proudly serves itself for a family gathering, a
                                                    dinner party, a birthday celebration, a baby christening, and a gift
                                                    to someone special or simply to have on hand on the cake stand at
                                                    home served with an ice cold glass of milk!
                                                </p>
                                        ...
                                        <Card className="mb-4">
                                            <CardBody className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="progress-bar-circle">
                                                    <CircularProgressbar strokeWidth={4} percentage={85} text={'85%'} />
                                                </div>
                                            </CardBody>
                                        </Card>
                                        ...
                                        <Card className="mb-4">
                                            <CardBody className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="progress-bar-circle">
                                                    <CircularProgressbar strokeWidth={4} percentage={40} text={'40%'} />
                                                </div>
                                            </CardBody>
                                        </Card>
                                    </Colxx>
                                            ...
                                            <CardBody>
                                                ...
                                                <div className="d-flex flex-row mb-3 pb-3 border-bottom">
                                                    ...
                                                    <div className="pl-3 pr-2">
                                                        <NavLink to="#">
                                                            <p className="font-weight-medium mb-0">
                                                                This cake was delightful to eat. Please keep them
                                                                coming.
                                                            </p>
                                                            <p className="text-muted mb-1 text-small">
