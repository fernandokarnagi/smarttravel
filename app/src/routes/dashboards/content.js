...
import { visitChartConfig, conversionChartConfig } from 'Constants/chartConfig';
    ...
    render() {
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.content" />} match={this.props.match} />
                        ...
                        <Card className="progress-banner">
                            <CardBody className="justify-content-between d-flex flex-row align-items-center">
                                <div>
                                    ...
                                    <div>
                                        <p className="lead text-white">
                                            5 <IntlMessages id="dashboards.posts" />
                                        </p>
                                ...
                                <div className="progress-bar-circle progress-bar-banner position-relative">
                                    <CircularProgressbar strokeWidth={4} percentage={40} text={'5/12'} />
                                </div>
                            </CardBody>
                        </Card>
                    </Colxx>
                        ...
                        <Card className="progress-banner">
                            <CardBody className="justify-content-between d-flex flex-row align-items-center">
                                <div>
                                    ...
                                    <div>
                                        <p className="lead text-white">
                                            4 <IntlMessages id="dashboards.users" />
                                        </p>
                                        <p className="text-small text-white">
