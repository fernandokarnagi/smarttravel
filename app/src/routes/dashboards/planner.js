    ...
    render() {
        ...
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <h1>Let us help you to plan your route</h1>
                        ...
                        <Card>
                            <CardBody>
                                ...
                                <Row className="mb-4">
                                    ...
                                    <Colxx xxs="12" md="4">
                                        <FormGroup>
                                            <CustomInput type="checkbox" id="bus" label="Public Train" label="Walk" />
                                        </FormGroup>
                                    </Colxx>
                                </Row>
                                ...
                                <Button
                                    color="primary"
                                    className="mt-4"
                                    onClick={e => this.props.history.push('./routedetails')}>
                                    Plan my trip
                                </Button>
                            </CardBody>
                        </Card>
...
export default injectIntl(TravelPlanner);
