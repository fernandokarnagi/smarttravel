...
import { lineChartConfig, doughnutChartConfig } from 'Constants/chartConfig';

import { LineShadow, DoughnutShadow } from 'Components/Charts';
    ...
    render() {
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.ecommerce" />} match={this.props.match} />
