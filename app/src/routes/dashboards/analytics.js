...
import { PolarShadow, LineShadow, SmallLineChart, RadarShadow, DoughnutShadow } from 'Components/Charts';
    ...
    render() {
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.analytics" />} match={this.props.match} />
