                                            ...
                                            return (
                                                <div key={index} className="d-flex flex-row mb-3 pb-3 border-bottom">
                                                    ...
                                                    <div className="pl-3 pr-2">
                                                        <NavLink to="/app/layouts/details">
                                                            <p className="font-weight-medium mb-0 ">{ticket.label}</p>
                                                            <p className="text-muted mb-0 text-small">{ticket.date}</p>
                                                        </NavLink>
                                                    </div>
                                                </div>
                                            );
                        ...
                        <Card>
                            ...
                            <CardBody className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="progress-bar-circle">
                                    <CircularProgressbar strokeWidth={4} percentage={64} text={'64%'} />
                                </div>
                            </CardBody>
                        </Card>
                    </Colxx>
                    <Colxx xl="3" lg="6" className="mb-4">
                        <Card>
                            ...
                            <CardBody className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="progress-bar-circle">
                                    <CircularProgressbar strokeWidth={4} percentage={75} text={'75%'} />
                                </div>
                            </CardBody>
                        </Card>
                    </Colxx>
                    <Colxx xl="3" lg="6" className="mb-4">
                        <Card>
                            ...
                            <CardBody className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="progress-bar-circle">
                                    <CircularProgressbar strokeWidth={4} percentage={32} text={'32%'} />
                                </div>
                            </CardBody>
                        </Card>
                    </Colxx>
                    <Colxx xl="3" lg="6" className="mb-4">
                        <Card>
                            ...
                            <CardBody className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="progress-bar-circle">
                                    <CircularProgressbar strokeWidth={4} percentage={60} text={'45%'} />
                                </div>
                            </CardBody>
                        </Card>
                    </Colxx>
                                ...
                                <Card className="progress-banner">
                                    <CardBody className="justify-content-between d-flex flex-row align-items-center">
                                        ...
                                        <div className="progress-bar-circle progress-bar-banner position-relative">
                                            <CircularProgressbar strokeWidth={4} percentage={41} text={'5/12'} />
                                        </div>
                                    </CardBody>
                                </Card>
                            </Colxx>
                            ...
                            <Colxx lg="4" xl="12" className="mb-4">
                                <Card className="progress-banner">
                                    <CardBody className="justify-content-between d-flex flex-row align-items-center">
                                        ...
                                        <div className="progress-bar-circle progress-bar-banner position-relative">
                                            <CircularProgressbar strokeWidth={4} percentage={66} text={'4/6'} />
                                        </div>
                                    </CardBody>
                                </Card>
                            </Colxx>
                            ...
                            <Colxx lg="4" xl="12" className="mb-4">
                                <Card className="progress-banner">
                                    <CardBody className="justify-content-between d-flex flex-row align-items-center">
                                        ...
                                        <div className="progress-bar-circle progress-bar-banner position-relative">
                                            <CircularProgressbar strokeWidth={4} percentage={80} text={'8/10'} />
                                        </div>
                                    </CardBody>
                                </Card>
                            </Colxx>
                            ...
                            <CardBody>
                                ...
                                <ReactSiemaCarousel
                                    ...
                                    <div className="pr-2 pl-2">
                                        <img src="/assets/img/carousel-1.jpg" alt="Cheesecake" className="mb-4" />
                                        <h6 className="mb-1">
                                        ...
                                        <p className="text-small text-muted mb-0 d-inline-block">(48)</p>
                                    </div>

                                    <div className="pr-2 pl-2">
                                        <img src="/assets/img/carousel-2.jpg" alt="Cheesecake" className="mb-4" />
                                        <h6 className="mb-1">
                                        ...
                                        <p className="text-small text-muted mb-0  d-inline-block">(24)</p>
                                    </div>

                                    <div className="pr-2 pl-2">
                                        <img src="/assets/img/carousel-3.jpg" alt="Cheesecake" className="mb-4" />
                                        <h6 className="mb-1">
                                        ...
                                        <Rating total={5} rating={4} interactive={false} />
                                        <p className="text-small text-muted mb-0  d-inline-block">(18)</p>
                                    </div>
                                </ReactSiemaCarousel>
                            </CardBody>
                        </Card>
