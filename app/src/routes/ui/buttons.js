    ...
    render() {
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.buttons" />} match={this.props.match} />
                        ...
                        <Card className="mb-4">
                            <CardBody>
                                ...
                                <ButtonGroup className="mb-2">
                                    <Button>1</Button>
                                    <Button>2</Button>
                                    <ButtonDropdown isOpen={this.state.nestingDropdownOpen} toggle={this.nestingToggle}>
