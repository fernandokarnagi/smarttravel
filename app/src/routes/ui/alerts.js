...
import { Alert, UncontrolledAlert, Row, Card, CardBody, CardTitle, Button, CardSubtitle } from 'reactstrap';
        ...
        return () => {
            switch (type) {
                ...
                case 'info':
                    ...
                    break;
                case 'success':
                    NotificationManager.success('Success message', 'Title here', 3000, null, null, cName);
                    break;
                case 'warning':
                    NotificationManager.warning('Warning message', 'Close after 3000ms', 3000, null, null, cName);
                    break;
                case 'error':
    ...
    render() {
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.alerts" />} match={this.props.match} />
                    ...
                    <Colxx xxs="12">
                        <Card className="mb-4">
                            <CardBody>
                                ...
                                <Button outline className="mb-3" color="info" onClick={this.createNotification('info')}>
