    ...
    render() {
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.carousel" />} match={this.props.match} />
                        ...
                        <ReactSiemaCarousel
                            ...
                            <div className="pr-3 pl-3">
                                <Card className="flex-row">
                                    ...
                                    <div className="w-50">
                                        <CardBody>
                                            <h6 className="mb-4">Homemade Cheesecake with Fresh Berries and Mint</h6>
                            ...
                            <div className="pr-3 pl-3">
                                <Card className="flex-row">
                                    ...
                                    <div className="w-50">
                                        <CardBody>
                                            <h6 className="mb-4">Wedding Cake with Flowers Macarons and Blueberries</h6>
                                ...
                                <Card className="flex-row">
                                    ...
                                    <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                                        <CardBody className="align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero">
                                            ...
                                            <div>
                                                <span className="badge badge-pill badge-primary mr-1">NEW</span>
                    ...
                    <Colxx xxs="12" className="pl-0 pr-0 mb-4">
                        <ReactSiemaCarousel
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <div className="position-relative">
                                        <img className="card-img-top" src="/assets/img/card-thumb-1.jpg" alt="Card" />
                                        <span className="badge badge-pill badge-theme-1 position-absolute badge-top-left">
                                            NEW
                                        </span>
                                    ...
                                    <CardBody>
                                        <h6 className="mb-4">Cheesecake with Chocolate Cookies and Cream Biscuits</h6>
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <div className="position-relative">
                                        <img className="card-img-top" src="/assets/img/card-thumb-2.jpg" alt="Card" />
                                        <span className="badge badge-pill badge-theme-1 position-absolute badge-top-left">
                                            NEW
                                        </span>
                                        <span className="badge badge-pill badge-secondary position-absolute badge-top-left-2">
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <div className="position-relative">
                                        <img className="card-img-top" src="/assets/img/card-thumb-3.jpg" alt="Card" />
                                        <span className="badge badge-pill badge-theme-1 position-absolute badge-top-left">
                                            NEW
                                        </span>
                                        <span className="badge badge-pill badge-secondary position-absolute badge-top-left-2">
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <div className="position-relative">
                                        <img className="card-img-top" src="/assets/img/card-thumb-4.jpg" alt="Card" />
                                        <span className="badge badge-pill badge-theme-1 position-absolute badge-top-left">
                                            NEW
                                        </span>
                                        <span className="badge badge-pill badge-secondary position-absolute badge-top-left-2">
