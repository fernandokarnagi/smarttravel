...
import { Row, Card, CardBody, Button, Collapse, CardTitle, CardSubtitle } from 'reactstrap';
    ...
    render() {
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.collapse" />} match={this.props.match} />
                                ...
                                <Collapse isOpen={this.state.collapse}>
                                    <div className="p-4 border mt-4">
                                        <p className="mb-0">
                                            ...
                                            anderson cred nesciunt sapiente ea proident. Anim pariatur cliche
                                            reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.
                                        </p>
                                    </div>
                                </Collapse>
                            </CardBody>
