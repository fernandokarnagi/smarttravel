    ...
    render() {
        ...
        return (
            <Fragment>
                <Row>
                    <Colxx xxs="12">
                        <BreadcrumbContainer heading={<IntlMessages id="menu.forms" />} match={this.props.match} />
                        ...
                        <Card>
                            <CardBody>
                                ...
                                <AvForm className="av-tooltip mb-5 row">
                                    ...
                                    <Colxx sm={6}>
                                        <AvGroup>
                                            <Label className="av-label" for="avexampleLastNameTooltip">
                                                <IntlMessages id="forms.lastname" />
                                            </Label>
                                            <AvInput name="rank" id="avexampleLastNameTooltip" required />
                                            <AvFeedback>
                                                <IntlMessages id="forms.lastname-message" />
                                            </AvFeedback>
                                        </AvGroup>
                                    ...
                                    <Colxx sm={6}>
                                        <AvGroup>
                                            ...
                                            <AvInput name="rank" id="avexampleStateTooltip" required />
                                            <AvFeedback>
                                                <IntlMessages id="forms.state-message" />
                                            </AvFeedback>
                                        </AvGroup>
