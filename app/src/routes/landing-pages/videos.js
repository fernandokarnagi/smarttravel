...
import { Container, Row, Card, CardBody, Pagination, PaginationItem, PaginationLink, Badge } from 'reactstrap';
                                            ...
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        ...
                                                        src="/assets/img/landing-page/values-1.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
                                                ...
                                                <CardBody>
                                                    <NavLink to="/video-detail">
                                                        <h6 className="mb-4 video-heading ellipsis">
                                        ...
                                        <Colxx xxs="12" sm="6" lg="3" className="mb-5">
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        className="card-img-top"
                                                        src="/assets/img/landing-page/values-2.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
                                        ...
                                        <Colxx xxs="12" sm="6" lg="3" className="mb-5">
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        className="card-img-top"
                                                        src="/assets/img/landing-page/values-3.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
                                        ...
                                        <Colxx xxs="12" sm="6" lg="3" className="mb-5">
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        className="card-img-top"
                                                        src="/assets/img/landing-page/values-4.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
                                        ...
                                        <Colxx xxs="12" sm="6" lg="3" className="mb-5">
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        className="card-img-top"
                                                        src="/assets/img/landing-page/values-5.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
                                        ...
                                        <Colxx xxs="12" sm="6" lg="3" className="mb-5">
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        className="card-img-top"
                                                        src="/assets/img/landing-page/values-6.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
                                        ...
                                        <Colxx xxs="12" sm="6" lg="3" className="mb-5">
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        className="card-img-top"
                                                        src="/assets/img/landing-page/values-7.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
                                        ...
                                        <Colxx xxs="12" sm="6" lg="3" className="mb-5">
                                            <Card>
                                                <div className="position-relative">
                                                    ...
                                                    <img
                                                        className="card-img-top"
                                                        src="/assets/img/landing-page/values-8.jpg"
                                                        alt="Card cap"
                                                    />
                                                    <Badge
                                                        pill
