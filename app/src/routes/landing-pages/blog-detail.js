                    ...
                    <div className="main-container">
                        ...
                        <div
                            ...
                            <div className="section home subpage">
                                <Container>
                                    <SubHero
                                        title={messages['lp.blogdetail.title']}
                                        detail={messages['lp.blogdetail.detail']}
                                    />
                                    <Row>
                                        <NavLink
                                        ...
                                        <Colxx xxs="12" lg="7">
                                            <Card>
                                                <CardBody className="p-0">
                                                    <img
                                                        alt="subpage"
                                                        src="/assets/img/landing-page/subpage-image.jpg"
                                                        className="img-fluid card-img-fluid"
                                                    />
                                                </CardBody>
                                            </Card>
                                            ...
                                            <p
                                                className="mt-5 mb-0"
                                                dangerouslySetInnerHTML={{ __html: messages['lp.blogdetail.content'] }}
                                            />
                                        </Colxx>
