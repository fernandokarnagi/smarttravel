...
module.exports = {
    ...
    'lp.featuressection.detail-3-1':
        'Using charts is a good way to visualize data but they often look ugly and breaks the rhythm of design.',
    'lp.featuressection.detail-3-2':
        'We concentrated on a single chart library and tried to create charts that looks good with color, opacity, border and shadow.',
    'lp.featuressection.detail-3-3':
        'Used certain plugins and created some to make charts even more useful and beautiful.',

    'lp.reviews.title': 'Client Reviews',
    'lp.reviews.detail':
        'People love Gogo. We have received lots of awesome reviews for desing quality, documentation, code quality, flexibility, features, support and other categories. Here are some of them.',
    'lp.reviews.review-name-1': 'codebars',
    'lp.reviews.review-type-1': 'Code Quality',
    'lp.reviews.review-detail-1':
    ...
    'lp.clients.detail':
        'Humanitarian resist incubator movements outcomes. Low-hanging fruit synergy correlation accessibility; save the world unprecedented challenge scalable. Leverage strategy, and, game-changer, agile, social return on investment.',
    ...
    'lp.blogsection.detail-4':
        'Completely synergize resource taxing credibly pontificate highly efficient relationships via premier niche markets.',
    'lp.blogsection.title-5': 'Assertively Iterate Resource Maximizing',

    'lp.pricetable.title': 'Pricing',
    'lp.pricetable.detail':
        'Humanitarian resist incubator movements outcomes. Low-hanging fruit synergy correlation accessibility; save the world unprecedented challenge scalable. Leverage strategy, and, game-changer, agile, social return on investment.',
    ...
    'lp.timeline.detail':
        'Data citizen-centered granular, effective altruism white paper engaging; best practices thought partnership optimism. Shared value benefit corporation equal opportunity the resistance human-centered philanthropy revolutionary commitment co-create. Society, improve the world, resilient state of play equal opportunity indicators.',
    'lp.timeline.year-1': '2011',
    'lp.timeline.title-1': 'Foundation',
    'lp.timeline.subtitle-1': 'Citizen-centered incubator',
    'lp.timeline.detail-1':
        'Equal opportunity changemaker scalable society; movements commitment, fairness best practices. Youth white paper overcome injustice her body her rights blended value because strategize. A innovate; empower communities, activate save the world. Justice; policymaker systems thinking to change-makers.',
    'lp.timeline.year-2': '2013',
    'lp.timeline.title-2': 'Expanding',
    'lp.timeline.subtitle-2': 'Program area collective',
    'lp.timeline.detail-2':
        'Equal opportunity changemaker scalable society; movements commitment, fairness best practices. Youth white paper overcome injustice her body her rights blended value because strategize. Youth social impact thought leader program area collective impact. Data citizen-centered granular, effective altruism white paper engaging; best practices thought partnership optimism.',
    'lp.timeline.year-3': '2015',
    'lp.timeline.title-3': '1000th Customer',
    'lp.timeline.subtitle-3': 'Equal opportunity',
    'lp.timeline.detail-3':
        'Game-changer inclusion; thought leader change-makers milestones; benefit corporation storytelling. Compassion compelling emerging; invest humanitarian. Academic gender rights incubator systems thinking technology. Engaging strengthening infrastructure social capital justice but external partners.',
    'lp.timeline.year-4': '2017',
    'lp.timeline.title-4': 'First Office in USA',
    'lp.timeline.subtitle-4': 'Move the needle impact',
    'lp.timeline.detail-4':
        'Leverage social innovation state of play commitment natural resources targeted B-corp big data blended value. Society empathetic gender rights grit, fairness families thought leadership think tank thought partnership. Communities thought partnership social capital corporate social responsibility collaborate.',
    ...
    'lp.timeline.detail-5':
        'Ideate compassion accessibility, invest paradigm. Social entrepreneurship ideate effective altruism and social enterprise living a fully ethical life. Move the needle impact investing impact investing.',
    ...
    'lp.numbers.detail':
        'Social return on investment unprecedented challenge co-creation bandwidth entrepreneur compassion. Social entrepreneurship external partners; citizen-centered do-gooder human-centered sustainable radical.',
    ...
    'lp.blogdetail.detail':
        'Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition.',
    'lp.blogdetail.content':
    ...
    'lp.careers.detail':
        'Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override low hanging fruit to identify a ballpark.',
    'lp.careers-herd.title': 'Join the Herd',
    'lp.careers-herd.detail':
        'Data citizen-centered granular, effective altruism white paper engaging; best practices thought partnership optimism. Shared value benefit corporation equal opportunity the resistance human-centered philanthropy revolutionary commitment co-create. Society, improve the world, resilient state of play equal opportunity indicators.',

    'lp.careers-positions.title': 'Open Positions',
    'lp.careers-positions.detail':
        'Data citizen-centered granular, effective altruism white paper engaging; best practices thought partnership optimism.',
